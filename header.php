<?php include 'hamXuLy.php';include 'connected.php'; ?>
	<div class="header-line1">
		<ul>
			<li class="hotline"><img src="images/icon/phone.png" width="15" height="15"/><a href="tel:0523407436" class="format-url">052.340.7436&emsp;</a>
			</li>
			...
			<li class="adress">&emsp;<img src="images/icon/vitri.png" width="15" height="15"/><a class="format-url">Đông Thành -  Ninh Bình -TP Ninh Bình</a>
			</li>
		</ul>
	</div>
    ...
    <div class="menu-ngang">
      <ul>
        ...
        <li><a href="sanpham.php?pageall=0" class="format-url">Sản phẩm</a></li>
          ...
          <li style="border-right:none;padding-left:20px"><a href="huongdanmuahang.php" class="format-url">Hướng dẫn mua hàng</a></li>
      </ul>
    </div>
